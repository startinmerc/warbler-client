...
const LandingBackground = ({stroke})=>(
	<svg viewbox="0 0 100 100" className="svg-grid" style={gridStyles}>
		<line class="v"     x1="0%" y1="51%" x2="100%" y2="51%" stroke={stroke}/>
		<line class="v v-1" x1="0%" y1="51%" x2="100%" y2="51%" stroke={stroke}/>
		<line class="v v-2" x1="0%" y1="55%" x2="100%" y2="55%" stroke={stroke}/>
		<line class="v v-3" x1="0%" y1="60%" x2="100%" y2="60%" stroke={stroke}/>
		<line class="v v-4" x1="0%" y1="66%" x2="100%" y2="66%" stroke={stroke}/>
		<line class="v v-5" x1="0%" y1="73%" x2="100%" y2="73%" stroke={stroke}/>
		<line class="v v-6" x1="0%" y1="81%" x2="100%" y2="81%" stroke={stroke}/>
		<line class="v v-7" x1="0%" y1="90%" x2="100%" y2="90%" stroke={stroke}/>
		<line class="v v-8" x1="0%" y1="100%" x2="100%" y2="100%" stroke={stroke}/>
